...
function migrate(raw) {
  ...
  merged.mindMaps = (raw.mindMaps || defaultData.mindMaps).map(x => ({ title:'Mind Map', rootText:'Main Topic', updatedAt:'', ...x, nodes:Array.isArray(x.nodes)?x.nodes:[] }))
  return merged
}
