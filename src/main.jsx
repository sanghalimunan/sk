...
function CalendarPage({data,update,setModal}){
  const [selected,setSelected]=useState(iso()),[month,setMonth]=useState(new Date()),[query,setQuery]=useState('')
